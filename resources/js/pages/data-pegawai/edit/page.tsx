...
import { Employee, OrgUnit } from '../_types';
...
export default function Page({ orgUnits, employee }: { orgUnits: OrgUnit[], employee: Employee }) {
    console.log({ orgUnits , employee });

    const formAddEmployee = useForm('post', `/master/employees/${employee.id}?_method=PATCH`, {
        nip: employee.nip,
        name: employee.name,
                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        value={formAddEmployee.data.org_unit_id.toString()}
                                        onValueChange={(value) =>
                                            formAddEmployee.setData(
                                                'org_unit_id',
                                                value,
