            ...
            <main className="max-w-8xl mx-auto w-full px-4 sm:px-6 lg:px-8">
                <div className="">
                    ...
                    <p className="text-gray-600">
                        Use this form to view and manage asset details. You can
                        edit or delete assets as needed.
                    </p>
                </div>
            </main>
                    ...
                    <Card>
                        ...
                        <CardContent className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div className="grid gap-2 text-sm">
                                ...
                                />
                                <Row k="Item" v={assignment.asset.item_name} />
                                <Row k="Tipe" v={assignment.asset.type.name} />
                                <Row
                                    k="Brand/Model"
                                            ...
                                            <DialogContent className="sm:max-w-[425px]">
                                                ...
                                                <div className="flex flex-col items-center justify-center">
                                                    <QRCode
                                                        id="QRCode"
                                                        value={
                                                            `http://localhost/detail-asset/${assignment.key_qr}`
                                                        }
                                                        size={256}
                                                        viewBox={`0 0 21 21`}
                                                    />
